...
public class SonServiceImpl implements SonService {
    ...
    public SonServiceImpl(EmployeeMapper employeeMapper) {
    ...
    @SonTransaction
    @Override
    public void sonMethod1(String args, Thread thread) throws Exception {
    ...
    @SonTransaction
    @Override
    public void sonMethod2(String args1, String args2, Thread thread) throws Exception {
        double ran = Math.random();
        Employee employee = new Employee();
        employee.setEmployeeName(args1 + args2);
        employee.setAge(18);
        employee.setGender(1);
        employee.setBirthDate(Calendar.getInstance().getTime());
        employee.setIdNumber(String.valueOf(ran));
    ...
    @SonTransaction
    @Override
    public void sonMethod3(String args, Thread thread) throws Exception {
        double ran = Math.random();
        Employee employee = new Employee();
        employee.setEmployeeName(args);
        employee.setAge(18);
    ...
    @Transactional(rollbackFor = Exception.class)
    @Override
    public void sonMethod4(String args) throws Exception {
        double ran = Math.random();
        Employee employee = new Employee();
        employee.setEmployeeName(args);
        employee.setAge(18);
...
//        throw new BizException("9999999");
    }
}
