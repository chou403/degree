...
//            put("jvid", "e40c9dccec7fad98cf6487d8e709752e");
//            put("mobile", AES256Util.encode(DEFAULT_SECRET_KEY, "18916593752"));
//            put("name", "chen");
//            put("time", "13333333333");
//            put("reason", "不喜欢");
//        }};
//        String dbPassword = "123456";
//        String encryptDbPwd = AES256Util.encode(DEFAULT_SECRET_KEY, JsonHelper.parseToJson(requestParams));
//        System.out.println("encrypt: " + requestParams);
//        System.out.println("encrypt: " + encryptDbPwd);
//
//        System.out.println(requestParams.get("mobile"));
//
//        String decrypt = AES256Util.decode(DEFAULT_SECRET_KEY, String.valueOf(requestParams));
