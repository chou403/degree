...
public class DateUtil {
    ...
    private static final List<String> FMT_LIST = new ArrayList<>() {
        ...
        {
            add(BaseConstants.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS);
            add(BaseConstants.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI);
            add(BaseConstants.DATE_FORMAT_YYYY_MM_DD_HH);
            add(BaseConstants.DATE_FORMAT_YYYY_MM_DD);
        }
    };
    ...
    public static int monthsBetween(String yearMonth) {
        Date data1 = cn.hutool.core.date.DateUtil.date();
        Date date2 = cn.hutool.core.date.DateUtil.parse(yearMonth);
        return (int) cn.hutool.core.date.DateUtil.betweenMonth(data1, date2, true);
    }
    ...
    public static String getCurrentDateHms() {
        SimpleDateFormat sf = new SimpleDateFormat(BaseConstants.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS);
    ...
    public static String getCurrentDate() {
        SimpleDateFormat sf = new SimpleDateFormat(BaseConstants.DATE_FORMAT_YYYY_MM_DD);
        return sf.format(new Date());
    }
    ...
    public static String getCurrentMonth() {
        SimpleDateFormat sf = new SimpleDateFormat(BaseConstants.DATE_FORMAT_YYYY_MM);
        return sf.format(new Date());
    }
    ...
    public static String getLastDayOfMonth(String yearmonth) {
        try {
            SimpleDateFormat format = new SimpleDateFormat(BaseConstants.DATE_FORMAT_YYYY_MM);
    ...
    public static Long getDayToDayOfMinutes(String date) {
        java.time.format.DateTimeFormatter dtf = java.time.format.DateTimeFormatter.ofPattern(BaseConstants.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI);
    ...
    public static String getDateOfTimeStamp(Long timeStamp) {
        SimpleDateFormat sdf = new SimpleDateFormat(BaseConstants.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS);
    ...
    public static String getDateOfAddDay(int num) {
        SimpleDateFormat format = new SimpleDateFormat(BaseConstants.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS);
    ...
    public static String getStrFormatToStr(String time) {
        DateFormat dateFormat = new SimpleDateFormat(BaseConstants.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS);
        String date;
        try {
    ...
    public static Date getDateAfterTime(String dateStr, int time, int timeType) {
        try {
            SimpleDateFormat df = new SimpleDateFormat(BaseConstants.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS);
            Calendar cal = Calendar.getInstance();
